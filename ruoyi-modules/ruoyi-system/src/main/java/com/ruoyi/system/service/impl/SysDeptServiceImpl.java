...
public class SysDeptServiceImpl implements ISysDeptService
{
    ...
    public void checkDeptDataScope(Long deptId)
    {
        if (!SecurityUtils.isAdmin() && StringUtils.isNotNull(deptId))
        {
            ...
            {
                throw new ServiceException(remoteTranslateService.translate("system.dept.no.permission", null));
            }
        }
    }
    ...
    public int insertDept(SysDept dept)
    {
        ...
        {
            throw new ServiceException(remoteTranslateService.translate("system.dept.disabled.cannot.add", null));
        }
    ...
    public void updateDeptSort(String[] deptIds, String[] orderNums)
    {
        ...
        {
            throw new ServiceException(remoteTranslateService.translate("sort.save.error", null));
        }
    }
