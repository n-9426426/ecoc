...
import com.ruoyi.system.common.PasswordVerify;
...
public class SysUserController extends BaseController
{
    ...
    {
        PasswordVerify.passwordVerify(sysUser.getPassword());
    ...
    {
        PasswordVerify.passwordVerify(user.getPassword());
